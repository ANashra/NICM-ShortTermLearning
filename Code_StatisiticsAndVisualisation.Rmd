...
```
Note: Alteration_Type is Stimuli-Types, sd1 is Structurally Same, sd is Altered.
...
```
As we found no significant interactions in Test, We combine all three into Metrical
...
```
Checking whether irrespective of the Condition, if there was a difference in experts vs others
```{r for experts}
...
This has not been reported in the paper as we did not want to provide differences between the rhythmic cycles but is a way to compare ISO and NI like Hannon et al. (2012).
